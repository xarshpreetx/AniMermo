...
class AccountSelectActivity : FragmentActivity(), BiometricCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // AnimeMesmo: Sempre mostrar seleção de perfis (estilo Netflix)
        // App começa sem perfis - usuário deve criar o primeiro
        
        val skipStartup = false // Sempre mostrar tela de perfis
