...
class SettingsFragment : BaseFragment<MainSettingsBinding>(
    ...
    override fun onBindingCreated(binding: MainSettingsBinding) {
        ...
        binding.apply {
            ...
            // Ocultar opção de Extensions (app dedicado AnimeFire)
            settingsExtensions.visibility = android.view.View.GONE
            
            // Adicionar navegação para trocar de perfil
            settingsProfiles.setOnClickListener {
                activity?.let { act ->
                    val intent = android.content.Intent(act, com.lagradost.cloudstream3.ui.account.AccountSelectActivity::class.java)
